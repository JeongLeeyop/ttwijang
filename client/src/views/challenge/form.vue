  ...
  >
    ...
    <div class="board-head__box">
      ...
      :headers="requestHeaders"
          :action="`${apiUrl}/challenge/record/upload`"
      ...
      <el-form-item class="notice-form__btn">
        <el-button v-if="!this.uid" class="gft" style="border-color: #58c0d6; background-color: #fff; color: #58c0d6;" @click="handleClickCancle()">취소</el-button>
