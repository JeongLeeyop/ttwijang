...
export const getRegionLeagues = (sidoCode: string) => request({ url: `${ADMIN_PATH}/${sidoCode}/leagues`, method: 'get' });

export const getRegionTeams = (sidoCode: string) => request({ url: `${ADMIN_PATH}/${sidoCode}/teams`, method: 'get' });
